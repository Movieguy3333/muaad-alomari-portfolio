      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <h3 className="text-xl md:text-2xl text-ink-muted mb-8 max-w-2xl leading-relaxed">
              Full Stack Web Developer
            </h3>
            <p className="text-ink-muted mb-8 max-w-2xl leading-relaxed">
              I'm a full-stack software engineer graduating from Brooklyn
              College, CUNY with a 3.96 GPA and Dean's Honor Award. I specialize
              in building high-performance, real-time web applications, with a
              strong focus on scalable architecture and robust system design. My
              core stack is React, Next.js, and TypeScript.
            </p>
