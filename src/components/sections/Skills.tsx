  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <h2
          id="skills-heading"
          className="text-3xl md:text-4xl font-bold text-ink mb-14 tracking-tight"
        >
          Technical Skills
        </h2>
              ...
              <div className="bg-cream-50 border border-cream-300 rounded-2xl p-6 h-full">
                ...
                <ul className="space-y-2">
                  {items.map((skill) => (
                    <li
                      key={skill}
                      className="px-3 py-2 bg-cream-100 border border-cream-300 rounded-lg text-sm text-ink-muted cursor-default"
                    >
                      {skill}
                    </li>
                  ))}
